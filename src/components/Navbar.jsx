...
import {IoPersonAdd, IoLogIn, IoLogOut, IoPerson, IoChevronDownSharp, IoBagAdd, IoBagSharp} from "react-icons/io5";
          ...
          <div className="py-1">
            ...
            <Menu.Item>
              {({ active }) => (
                ...
                >
                    <IoBagAdd className='h-5 w-5 inline-flex'/> Agregar pedidos
                </Link>
              )}
            </Menu.Item>
          </div>
